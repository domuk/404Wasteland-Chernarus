...
{   
	...
	switch (_markerState) do {
        ...
        case 2:{ // Enemy NO friendly
            ...
            hintSilent parseText format ["<t size='2' color='#E01B1B'>%1</t><br/><br/>%2.","ATTENTION!","Enemy player detected by radar!"];
        };
        case 3:{ // Enemy AND friendly
        	_colorSelected = _colorBoth;
            _textSelected = "Players detected : Mixed";
            hintSilent parseText format ["<t size='2' color='#E01B1B'>%1</t><br/><br/>%2.","ATTENTION!","Enemy and Friendly players detected by radar!"];
        };
    };
